...
<%=printHeader(request,session)%>
		...
		<div class="modal fade bs-example-modal-lg" id="profileDiv">
    		...
    		<!--  SCRIPT TEST REPORT -->
		<div class="modal fade bs-example-modal-lg" id="testReportDiv">
			<div class="modal-dialog modal-lg">
			 	<div class="modal-content">
			 		 <div class="modal-header" id=testReportHeader>
			 			<button type="button" class="close" data-dismiss="modal">
			 				<span aria-hidden="true">&times;</span>
			 				<span class="sr-only">Close</span>
			 			</button>
				 	 ...
				 	 <div class="modal-body" id="testReportBody">
				  		<div id="testReportMain" class="panel panel-primary"  style="min-height: 580px; max-height: 580px; overflow-y: scroll; overflow-x: scroll; ">
		...
		<!--  ATTACHMENT -->
		<div class="modal fade bs-example-modal-lg" id="showAttachmentDiv">
			<div class="modal-dialog modal-lg">
			 	<div class="modal-content">
			 		 <div class="modal-header" id=showAttachmentHeader>
			 			<button type="button" class="close" data-dismiss="modal">
			 				<span aria-hidden="true">&times;</span>
			 				<span class="sr-only">Close</span>
			 			</button>
				 	 ...
				 	 <div class="modal-body" id="showAttachmentBody">
				  		<div id="showAttachmentMain" class="panel panel-primary"  style="min-height: 400px; max-height: 600px; overflow-y: scroll; overflow-x: scroll; ">
    ...
    <div class="container" id=MonitoringContainerDiv>
